    ...
    <form action="${ctx}/news/findBySql" id="listform" method="post">
        <div class="padding border-bottom">
            <ul class="search" style="padding-left: 10px;">
                <%--添加帮助服务信息--%>
                <li>
                    <a class="button border-main icon-plus-square-o" href="${ctx}/news/add">添加帮助服务信息</a>
                </li>
                <li>
                    <%--***--%>
                    <input type="text" placeholder="请输入标题" name="name" class="input" value="${obj.name}"
