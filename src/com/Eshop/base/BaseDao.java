...
public interface BaseDao<T>{
    ...
    /**  
     * 根据实体主键删除一个实体
     * (使用Serializable类型减少类型间的转换(string int),相当于Object接收模式)
     */  
     ...
     * @return
     */
    List<T> findByCount(Map<String,Object> params);
     ...
     * @return
     */
    Map<String,Object> getBySqlReturnMap(@Param("sql")String sql);
     ...
     * @return
     */
    List<Map<String,Object>> listBySqlReturnMap(@Param("sql")String sql);
     ...
     * @return
     */
    List<T> findBySqlRerturnEntity(@Param("sql")String sql);
